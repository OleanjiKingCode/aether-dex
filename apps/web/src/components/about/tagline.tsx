...
export const Tagline = () => {
  return (
    <div className="relative mx-auto flex min-h-[25dvh] max-w-full flex-col items-center justify-center gap-6 px-2 py-12 font-geist-mono text-muted-foreground sm:py-4">
      <div className="absolute top-0 right-46 hidden h-full w-[1px] translate-y-[1px] [background:repeating-linear-gradient(to_bottom,rgba(255,255,255,0.2)_0_8px,transparent_8px_16px)] sm:block" />
